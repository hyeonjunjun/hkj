...
/** ms between frame swaps. ~10s cycle — the reel takes ~2.5s to
 *  fully settle, leaving ~7.5s to read each line before the next
 *  reel kicks off. */
export const VESTABOARD_INTERVAL_MS = 10_000;
